...
var mid = gods.filter(god => god.roles.includes("Mid"))
mid.sort((a, b) => a.pantheon.localeCompare(b.pantheon))
console.log(mid)

console.log("Q3:")
// Q3

var sorted_gods = gods
sorted_gods.sort((a, b) => a.pantheon.localeCompare(b.pantheon))
console.log(sorted_gods)

console.log("Q4:")
// Q4

const gods_class = gods.map(god => god.name + "(" + god.class + ")")
console.log(gods_class)